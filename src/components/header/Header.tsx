    ...
    <>
      <header className="shadow-md">
          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            ...
            <div className="flex items-center">
              <button type="button" data-dropdown-toggle="language-dropdown"
                className="inline-flex items-center text-white hover:bg-background hover:text-accent focus:ring-4 focus:ring-background font-medium rounded-lg text-sm px-2 lg:px-4 py-2 lg:py-2.5 mr-2 md:mr-3 focus:outline-none">
                <svg className="w-5 h-5 rounded-full md:mr-2" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <g id="c">
                        <g id="e">
                          <g id="b">
                            ...
                            <use xmlnsXlink="" href="#a" y="420" />
                            <use xmlnsXlink="" href="#a" y="840" />
                            <use xmlnsXlink="" href="#a" y="1260" />
                          </g>
                          <use xmlnsXlink="" href="#a" y="1680" />
                        </g>
                        <use xmlnsXlink="" href="#b" x="247" y="210" />
                      </g>
                      <use xmlnsXlink="" href="#c" x="494" />
                    </g>
                    <use xmlnsXlink="" href="#d" x="988" />
                    <use xmlnsXlink="" href="#c" x="1976" />
                    <use xmlnsXlink="" href="#e" x="2470" />
                  </g>
                </svg>
                <span className="hidden mr-2 md:inline">English</span>
                <svg className="hidden w-4 h-4 md:inline" fill="none" stroke="currentColor" viewBox="0 0 24 24"
              ...
              <div className="hidden z-50 my-4 w-48 text-base list-none bg-white rounded divide-y divide-gray-100 shadow "
                      ...
                      <div className="inline-flex items-center">
                        <svg className="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
                          ...
                          <use width="30" height="20"
                            transform="rotate(-121 142.6 -47) scale(25.5827)" xmlnsXlink="" href="#a" />
                          <use width="30" height="20" transform="rotate(-98.1 198 -82) scale(25.6)"
                            xmlnsXlink="" href="#a" />
                          <use width="30" height="20"
                            transform="rotate(-74 272.4 -114) scale(25.6137)" xmlnsXlink="" href="#a" />
                          <use width="30" height="20"
                            transform="matrix(16 -19.968 19.968 16 256 230.4)" xmlnsXlink="" href="#a" />
                        </svg>
                        中文 (繁體)
                      </div>
                    </Link>
              ...
              <Link href="#"
                className="text-sm font-medium text-secondary hover:underline">Login</Link>
              <span className="mr-0 ml-2 w-px h-5 bg-gray-200 lg:inline lg:mr-3 lg:ml-5"></span>
              <Link href="#"
          ...
          <div className="grid py-4 px-4 mx-auto max-w-screen-xl lg:grid-cols-2 md:px-6">
            <form className="flex mb-4 lg:order-2 lg:mb-0">
              <label htmlFor="search-dropdown"
                className="mb-2 text-sm font-medium text-gray-900 sr-only ">Your Email</label>
              ...
              <div className="relative w-full">
                <input type="search" id="search-dropdown"
                  className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg md:rounded-l-none md:border-l-gray-50 border-l-1 md:border-l-6 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 "
                  placeholder="Search anything..." required />
                <button type="submit"
                  className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 "><svg
              ...
              <ul className="flex flex-row mt-0 space-x-8 text-sm font-medium">
                ...
                <li>
                  <button id="dropdown-button-megamenu" data-collapse-toggle="megamenu"
                    className="flex justify-between items-center w-full font-medium md:p-0 md:w-auto hover:text-blue-500">Company
                ...
                <li>
                  <Link href="#"
                    className="text-gray-900 hover:text-blue-600">Marketplace</Link>
                </li>
                <li>
                  <Link href="#"
                    className="hidden text-gray-900  hover:text-blue-600 md:inline ">Resources</Link>
                </li>
                <li>
                  <Link href="#"
                    className="hidden text-gray-900 hover:text-blue-600 md:inline">Contact</Link>
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav id="megamenu" className="bg-white border-b border-gray-200">
          <div
            className="grid py-4 px-4 mx-auto max-w-screen-xl text-gray-900 md:grid-cols-2 lg:grid-cols-4 md:px-6">
