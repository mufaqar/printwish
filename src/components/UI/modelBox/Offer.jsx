               ...
               >
                    <div className="p-2">
                         ...
                         <section className="text-center my-6 mb-10">
                              ...
                              <button className="mt-10 hover:scale-105"><Link href="#" className="bg-red-600 text-white font-semibold p-4 text-sm sm:text-xl rounded-lg px-5">PLACE ORDER AND GET 15% OFF</Link></button>
                         </section>
                         </div>
                    </div>
