            ...
            <div className='max-w-screen-xl mx-auto px-4'>
                ...
                <div className='grid md:grid-cols-5 grid-cols-1 md:gap-5 gap-10 mt-20'>
                    <div className='bg-white  shadow relative px-3 py-5 rounded-lg'>
                        <h3 className='w-fit absolute -top-5 mx-auto inset-x-0 text-accent text-2xl leading-none bg-primary px-3 py-1.5 rounded-full text-white'>
                            1
                        </h3>
                        <p className='text-lg font-medium text-accent text-center my-4'>
                            WE QUOTE IT
                        </p>
