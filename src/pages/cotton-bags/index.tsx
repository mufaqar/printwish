        ...
        {bags?.map((data: any, idx: number) => {
          return (
            <article className="p-1" key={idx}>
              <div className=''>
                <Link href={`/cotton-bags/${data?.slug}`} className=' md:h-[300px] cursor-pointer flex flex-col justify-center items-center group'>
                ...
                <div className='flex flex-col justify-center items-center'>
                  <h5 className="min-h-[40px]">
                    <Link href={`/cotton-bags/${data?.slug}`} className='text-sm font-bold flex font-roboto text-accent hover:text-secondary'>
