...
function SingleBlog() {
    return (
        <>
            <main className='  items-center lg:flex justify-between lg:ml-10 lg:mr-10 max-w-screen-xl px-6 md:px-6 py-5 '>
                ...
                <div className="container lg:w-[800px]">
                    ...
                    <div className="cont lg:pl-[85px]">
                        ...
                        <div className="icons lg:flex text-black  lg:w-[900px] border-b-[1px] pb-[1.5rem] lg:space-x-6 ">
                                ...
                                {Data.map((item, idx) => {
                                    return (
                                        <div key={idx} className="Detail">
                                            ...
                                            <h3 className='text-[20px] font-[600] mt-[5px] tracking-[.3px] leading-[26px] mb-[15px] text-[#222529] lg:w-[250px] font-OpenSans'><Link href={"https://printwish.co.uk/how-to-start-a-custom-t-shirt-printing-business/"}>
                                                {item.title}</Link></h3>
