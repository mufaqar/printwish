      ...
      <main className='md:flex container mx-auto px-4 gap-10 mt-7 font-opensans mb-20'>
        ...
        <section className='md:w-[60%] text-accent'>
          ...
          }
          {
            ...
            <h6>Unit Price : <span className='font-semibold'>£{selectedProduct?.colors[0]?.name === "WHITE" ? whitesmall + calculatePrintingPrice(customizedMergeData[0], totalQuantity) : colorsmall + calculatePrintingPrice(customizedMergeData[0], totalQuantity) }</span></h6>
          </div>
          }
